...
const CURATED_OVERRIDE_MESSAGE_MATCHERS = [
  ...
  },
  {
    ...
    list: ["hasta", "hastalık", "hastalik", "şifa", "sifa", "hastayım", "hastayim", "iyileş", "iyiles", "çok hastayım", "hastanedeyim", "iyileşmek istiyorum", "acı çekiyorum"],
  },
  {
...
const CURATED_OVERRIDE_SIGNAL_KEYS = {
  ...
  [normalizeThemeKey("kaygı")]: ["kaygı", "kaygi", "gelecek kaygısı", "gelecek kaygisi", "kaygım", "kaygim", "gelecek kaygım", "gelecek kaygim", "kaygım arttı", "kaygim artti", "gelecekten korkuyorum", "yarın ne olacak", "yarin ne olacak", "gelecek için endişeliyim", "endişe", "endise"],
  [normalizeThemeKey("sabır_sıkıntı")]: ["sabır", "sabir", "sabretmek", "sabredemiyorum", "dayanmak", "dayanamıyorum", "zor zamanlar", "sıkıntı", "sikinti", "sabrımı", "sabrimi", "zor zamanlarda sabır", "zor zamanlarda sabir", "birini kaybettim", "yas"],
