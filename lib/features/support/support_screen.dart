...
const _supportTiers = [
  _SupportTier(
    ...
    description: 'Uygulamanın gelişimine katkı sağla.',
  ),
  _SupportTier(
  ...
  _SupportTier(
    productId: SupportService.ozelProductId,
    title: 'Özel Destek',
    fallbackAmount: '300 TL',
    description: 'Ekstra katkınla HAKAI\'yi büyüt.',
  ),
  _SupportTier(
    productId: SupportService.buyukProductId,
    title: 'Büyük Destek',
    fallbackAmount: '500 TL',
    description: 'Büyük katkınla HAKAI\'yi büyüt.',
  ),
  _SupportTier(
    productId: SupportService.plusProductId,
    title: 'Plus Destek',
    fallbackAmount: '1.000 TL',
    description: 'En büyük katkınla HAKAI\'nin geleceğine ortak ol.',
  ),
];
